_nika() {
    ...
    do
        case "${cmd},${i}" in
            ...
            nika,wire)
                ...
                ;;
            nika__subcmd__arm,disarm)
                cmd="nika__subcmd__arm__subcmd__disarm"
                ;;
            nika__subcmd__arm,fire)
                cmd="nika__subcmd__arm__subcmd__fire"
                ;;
            nika__subcmd__arm,help)
                cmd="nika__subcmd__arm__subcmd__help"
                ;;
            nika__subcmd__arm,migrate)
                cmd="nika__subcmd__arm__subcmd__migrate"
                ;;
            nika__subcmd__arm__subcmd__help,disarm)
                cmd="nika__subcmd__arm__subcmd__help__subcmd__disarm"
                ;;
            nika__subcmd__arm__subcmd__help,fire)
                cmd="nika__subcmd__arm__subcmd__help__subcmd__fire"
                ;;
            nika__subcmd__arm__subcmd__help,help)
                cmd="nika__subcmd__arm__subcmd__help__subcmd__help"
                ;;
            nika__subcmd__arm__subcmd__help,migrate)
                cmd="nika__subcmd__arm__subcmd__help__subcmd__migrate"
                ;;
            nika__subcmd__help,arm)
                cmd="nika__subcmd__help__subcmd__arm"
                ;;
            ...
            nika__subcmd__help,explain)
                ...
                ;;
            nika__subcmd__help,guard)
                cmd="nika__subcmd__help__subcmd__guard"
                ;;
            ...
            nika__subcmd__help,key)
                ...
                ;;
            nika__subcmd__help,list)
                cmd="nika__subcmd__help__subcmd__list"
                ;;
            ...
            nika__subcmd__help,run)
                ...
                ;;
            nika__subcmd__help,serve)
                cmd="nika__subcmd__help__subcmd__serve"
                ;;
            ...
            nika__subcmd__help,trace)
                ...
                ;;
            nika__subcmd__help,try)
                cmd="nika__subcmd__help__subcmd__try"
                ;;
            ...
            nika__subcmd__help,wire)
                ...
                ;;
            nika__subcmd__help__subcmd__arm,disarm)
                cmd="nika__subcmd__help__subcmd__arm__subcmd__disarm"
                ;;
            nika__subcmd__help__subcmd__arm,fire)
                cmd="nika__subcmd__help__subcmd__arm__subcmd__fire"
                ;;
            nika__subcmd__help__subcmd__arm,migrate)
                cmd="nika__subcmd__help__subcmd__arm__subcmd__migrate"
                ;;
            ...
            nika__subcmd__help__subcmd__trace,peek)
                ...
                ;;
            nika__subcmd__help__subcmd__trace,receipt)
                cmd="nika__subcmd__help__subcmd__trace__subcmd__receipt"
                ;;
            ...
            nika__subcmd__help__subcmd__trace,rm)
                ...
                ;;
            nika__subcmd__help__subcmd__trace,session)
                cmd="nika__subcmd__help__subcmd__trace__subcmd__session"
                ;;
            ...
            nika__subcmd__trace,peek)
                ...
                ;;
            nika__subcmd__trace,receipt)
                cmd="nika__subcmd__trace__subcmd__receipt"
                ;;
            ...
            nika__subcmd__trace,rm)
                ...
                ;;
            nika__subcmd__trace,session)
                cmd="nika__subcmd__trace__subcmd__session"
                ;;
            ...
            nika__subcmd__trace__subcmd__help,peek)
                ...
                ;;
            nika__subcmd__trace__subcmd__help,receipt)
                cmd="nika__subcmd__trace__subcmd__help__subcmd__receipt"
                ;;
            ...
            nika__subcmd__trace__subcmd__help,rm)
                ...
                ;;
            nika__subcmd__trace__subcmd__help,session)
                cmd="nika__subcmd__trace__subcmd__help__subcmd__session"
                ;;
            ...
            nika__subcmd__trace__subcmd__help__subcmd__receipt,explain)
                ...
                ;;
            nika__subcmd__trace__subcmd__receipt,explain)
                cmd="nika__subcmd__trace__subcmd__receipt__subcmd__explain"
                ;;
            nika__subcmd__trace__subcmd__receipt,help)
                cmd="nika__subcmd__trace__subcmd__receipt__subcmd__help"
                ;;
            nika__subcmd__trace__subcmd__receipt__subcmd__help,explain)
                cmd="nika__subcmd__trace__subcmd__receipt__subcmd__help__subcmd__explain"
                ;;
            nika__subcmd__trace__subcmd__receipt__subcmd__help,help)
                cmd="nika__subcmd__trace__subcmd__receipt__subcmd__help__subcmd__help"
                ;;
            *)
                ;;
        esac
    ...
    case "${cmd}" in
        ...
        nika__subcmd__arm)
            ...
            case "${prev}" in
                --emit)
                    COMPREPLY=($(compgen -W "launchd systemd" -- "${cur}"))
                    return 0
                    ;;
                --out)
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__disarm)
            opts="-h --write --color --hyperlink --ascii --plain --help"
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__fire)
            opts="-h --now --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__help)
            opts="fire migrate disarm help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__help__subcmd__disarm)
            opts=""
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__help__subcmd__fire)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__help__subcmd__migrate)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__arm__subcmd__migrate)
        ...
        nika__subcmd__catalog)
            ...
            ;;
        nika__subcmd__check)
            opts="-h --json --infer-permits --fix --native-strict --profile --model --access --sdk-snapshot --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            case "${prev}" in
                --profile)
                    COMPREPLY=($(compgen -W "advisory operational" -- "${cur}"))
                    return 0
                    ;;
                --model)
                    COMPREPLY=($(compgen -f "${cur}"))
        ...
        nika__subcmd__doctor)
            opts="-h --ping --json --verbose --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        nika__subcmd__explain)
            ...
            ;;
        nika__subcmd__guard)
            opts="-h --stdin --command --cwd --human --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        nika__subcmd__help)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__arm)
            opts="fire migrate disarm"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__arm__subcmd__disarm)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__arm__subcmd__fire)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__arm__subcmd__migrate)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__help__subcmd__explain)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__guard)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__help__subcmd__key__subcmd__trust)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__list)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__help__subcmd__run)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__serve)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__help__subcmd__trace__subcmd__anchor)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__trace__subcmd__evidence)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__help__subcmd__trace__subcmd__peek)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__trace__subcmd__receipt)
            opts="explain"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__trace__subcmd__receipt__subcmd__explain)
            opts=""
        ...
        nika__subcmd__help__subcmd__trace__subcmd__rm)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__trace__subcmd__session)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__help__subcmd__trace__subcmd__verify)
            ...
            return 0
            ;;
        nika__subcmd__help__subcmd__try)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__help__subcmd__wire)
            ...
            ;;
        nika__subcmd__init)
            opts="-y -h --force --yes --recipe --example --theme --wire --project-file --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            case "${prev}" in
                ...
                --theme)
                    ...
                    ;;
                --wire)
                    COMPREPLY=($(compgen -W "cursor vscode windsurf claude claude-desktop cline codex continue zed opencode hermes gemini qwen lmstudio junie grok antigravity kimi kiro copilot amp detected all" -- "${cur}"))
                    return 0
                    ;;
                --color)
                    COMPREPLY=($(compgen -W "always never auto" -- "${cur}"))
        ...
        nika__subcmd__sign)
            ...
            ;;
        nika__subcmd__spec)
            opts="-h --canon --schema --project --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        nika__subcmd__test)
            opts="-h --update --answer --var --case --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        nika__subcmd__trace__subcmd__anchor)
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__evidence)
            opts="-o -h --out --workflow --json --full --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        nika__subcmd__trace__subcmd__help__subcmd__anchor)
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__help__subcmd__evidence)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__trace__subcmd__help__subcmd__peek)
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__help__subcmd__receipt)
            opts="explain"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__help__subcmd__receipt__subcmd__explain)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__trace__subcmd__help__subcmd__rm)
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__help__subcmd__session)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__trace__subcmd__ls)
            opts="-h --json --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        nika__subcmd__trace__subcmd__peek)
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__receipt)
            opts="-h --color --hyperlink --ascii --plain --help explain help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__receipt__subcmd__explain)
            opts="-h --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__receipt__subcmd__help)
            opts="explain help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__receipt__subcmd__help__subcmd__explain)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__receipt__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__trace__subcmd__rm)
            ...
            return 0
            ;;
        nika__subcmd__trace__subcmd__session)
            opts="-h --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        nika__subcmd__trace__subcmd__verify)
            opts="-h --key --anchored --sealed --json --replay --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        nika__subcmd__try)
            opts="-h --all --model --access --var --quiet --no-progress --max-cost-usd --resume --answer --color --hyperlink --ascii --plain --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        nika__subcmd__welcome)
            ...
            ;;
        nika__subcmd__wire)
            opts="-h --dir --dry-run --yes --color --hyperlink --ascii --plain --help cursor vscode windsurf claude claude-desktop cline codex continue zed opencode hermes gemini qwen lmstudio junie grok antigravity kimi kiro copilot amp detected all"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
